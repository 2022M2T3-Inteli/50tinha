...
app.post('/projetos/adicionar', urlencodedParser, (req, res) => {
    ...
    sql = `INSERT INTO PROJETOS (nome, area, mesInicio, anoInicio, mesFim, anoFim) VALUES ('${req.body.nome}', '${req.body.area}', '${req.body.mesInicio}', ${req.body.anoInicio}, '${req.body.mesFim}', ${req.body.anoFim})`;
    var db = new sqlite3.Database(DBPATH); //Abre o banco
    console.log(sql);
    db.run (sql, [], err => {
        if (err) {
